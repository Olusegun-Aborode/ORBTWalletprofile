...
def main():
    ...
    # 1. Wallet Ages
    if os.path.exists("wallet_ages.csv"):
        df_ages = pd.read_csv("wallet_ages.csv")
        schema_ages = [
    ...
    if os.path.exists("wallet_volumes.csv"):
        df_vol = pd.read_csv("wallet_volumes.csv")
    ...
    # 3. Gas Fees
    if os.path.exists("wallet_gas_fees.csv"):
