...
FINAL_FILE = "data/input/final_active_wallets.csv"
...
def main():
    ...
    # I should rename FINAL_FILE to 'data/intermediate/wallet_tx_counts.csv' if I want to overwrite, 
    # but the scripts use 'data/intermediate/wallet_tx_counts.csv' as input.
    # Actually, the scripts filter 'data/intermediate/wallet_tx_counts.csv' themselves.
    # So updating 'data/intermediate/wallet_tx_counts.csv' (which we did in step 4) is enough!
    # But saving a specific 'data/input/final_active_wallets.csv' is good for clarity.
