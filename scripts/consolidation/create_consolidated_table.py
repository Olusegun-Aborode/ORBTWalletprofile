...
# Portfolio (SIM & Dune)
df_sim = pd.read_csv("data/intermediate/wallet_portfolio_ath_backup.csv")
...
# Alchemy Balances
df_alc = pd.read_csv("data/intermediate/alchemy_eth_balances.csv")
...
# Save local CSV
final_df.to_csv("data/output/final_wallet_data.csv", index=False)
